...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Projects.video'
        db.alter_column('projects_projects', 'video', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Projects.video'
        raise RuntimeError("Cannot reverse this migration. 'Projects.video' and its values cannot be restored.")
