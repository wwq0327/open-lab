...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_projects', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('projects_projects')

        # Deleting model 'PrjFollower'
        db.delete_table('projects_prjfollower')
