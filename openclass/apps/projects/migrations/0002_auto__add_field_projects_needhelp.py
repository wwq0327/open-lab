...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Projects.needhelp'
        db.add_column('projects_projects', 'needhelp',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Projects.needhelp'
        db.delete_column('projects_projects', 'needhelp')
    ...
    models = {
        ...
        'projects.projects': {
            ...
            'needhelp': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
